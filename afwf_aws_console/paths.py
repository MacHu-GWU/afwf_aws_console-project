...
# Icons
# ------------------------------------------------------------------------------
dir_icons = dir_python_lib / "icons"
path_enum_arch_group = dir_icons / "enum_arch_group.py"
path_enum_arch_service = dir_icons / "enum_arch_service.py"
path_enum_category = dir_icons / "enum_category.py"
path_enum_resource = dir_icons / "enum_resource.py"
dir_asset = dir_icons / "asset"
dir_custom_asset = dir_asset / "custom"
